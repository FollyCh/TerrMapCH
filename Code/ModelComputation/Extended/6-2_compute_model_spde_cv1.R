...
valid <- aero[aero$fold %in% c(1),]
aero <- aero[aero$fold %in% c(2,3,4),]
...
# = = save = = 
saveRDS(res, "Output/results_cv1.rds")
saveRDS(aero, "Output/aero_results_cv1.rds")
saveRDS(valid,"Output/valid_results_cv1.rds")
